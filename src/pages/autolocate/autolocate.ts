...
@Component({
  templateUrl: 'autolocate.html'
})
export class AutolocatePage {
  autocompleteItems;
  autocomplete;
  ...
  geoCode(address:any) {
	...
	this.shareService.setCLAT( this.getDms(this.latitude));
	this.shareService.setCLNG(this.getDms(this.longitude));
