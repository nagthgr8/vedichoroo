 ...
 */
var RajayogaPage = /** @class */ (function () {
    function RajayogaPage(platform, navCtrl, navParams, appRate, shareService, horoService, renderer) {
        var _this = this;
        ...
        platform.ready().then(function () {
            ...
            _this.yogas = _this.shareService.getYOGAS();
            console.log(Object.keys(_this.yogas));
        });
    }
    RajayogaPage.prototype.ngAfterViewInit = function () {
    ...
    RajayogaPage.prototype.ngOnInit = function () {
    };
    RajayogaPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad RajayogaPage');
    };
    RajayogaPage.prototype.calcNavamsa = function () {
    ...
    RajayogaPage.prototype.loadHoro = function (plPos, ele, title) {
    ...
    RajayogaPage.prototype.grid = function (numberPerSide, size, pixelsPerSide, plps, title) {
    ...
    ], RajayogaPage.prototype, "birthChart", void 0);
    __decorate([
        ViewChild('navChart'),
        __metadata("design:type", Object)
    ], RajayogaPage.prototype, "navChart", void 0);
    RajayogaPage = __decorate([
        NgModule({
...
export { RajayogaPage };
//# sourceMappingURL=rajayoga.js.map