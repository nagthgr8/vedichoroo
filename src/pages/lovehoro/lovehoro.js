 ...
 */
var LovehoroPage = /** @class */ (function () {
    function LovehoroPage(platform, navCtrl, navParams, formBuilder, horoService, renderer, appRate, shareService) {
        var _this = this;
    ...
    LovehoroPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad LovehoroPage');
    };
    LovehoroPage.prototype.save = function () {
        var _this = this;
        ...
        this.horoService.getBirthStars(this.personalDetailsForm.controls['dob'].value, this.personalDetailsForm.controls['partnerdob'].value)
            ...
            _this.partnerBirthStar = res['partnerBirthStar'];
            _this.partnerBirthSign = res['partnerBirthSign'];
            _this.partnerBirthSignDeg = res['partnerBirthSignDeg'];
            _this.getLoveReport();
        }, function (err) {
            _this.info = err;
        });
    };
    LovehoroPage.prototype.getLoveReport = function () {
        this.showList = false;
        this.showGrid = true;
        ...
        for (var i = 0; i < Object.keys(nakshatras).length; i++) {
            ...
            if (bS != null && partnerbS != null) {
                ...
                if (s1 == partnerRashiNum || s2 == rashiNum)
                    iscomp = 1;
                else if (s3 == partnerRashiNum || s4 == rashiNum)
                    iscomp = 1;
                else if (s5 == partnerRashiNum || s6 == rashiNum)
                    iscomp = 1;
                else if (s7 == partnerRashiNum || s8 == rashiNum)
                    iscomp = 1;
                else if (s9 == partnerRashiNum || s10 == rashiNum)
                    iscomp = 1;
                ...
                var mvarna = '';
                var wvarna = '';
                if (this.birthSign.toLowerCase() == 'cancer' || this.birthSign.toLowerCase() == 'scorpio' || this.birthSign.toLowerCase() == 'pisces')
                    mvarna = 'priests';
                else if (this.birthSign.toLowerCase() == 'aries' || this.birthSign.toLowerCase() == 'leo' || this.birthSign.toLowerCase() == 'sagittarius')
                    mvarna = 'warriors';
                else if (this.birthSign.toLowerCase() == 'libra' || this.birthSign.toLowerCase() == 'aquarius' || this.birthSign.toLowerCase() == 'gemini')
                    mvarna = 'merchants';
                else
                    mvarna = 'labourers';
                if (this.partnerBirthSign.toLowerCase() == 'cancer' || this.partnerBirthSign.toLowerCase() == 'scorpio' || this.partnerBirthSign.toLowerCase() == 'pisces')
                    wvarna = 'priests';
                else if (this.partnerBirthSign.toLowerCase() == 'cancer' || this.partnerBirthSign.toLowerCase() == 'scorpio' || this.partnerBirthSign.toLowerCase() == 'pisces')
                    wvarna = 'warriors';
                else if (this.partnerBirthSign.toLowerCase() == 'cancer' || this.partnerBirthSign.toLowerCase() == 'scorpio' || this.partnerBirthSign.toLowerCase() == 'pisces')
                    wvarna = 'merchants';
                else
                ...
                rem = vdh + vnext;
                if (bS.name == 'ashwini' && partnerbS.name == 'jyestha')
                    rem = vdh + vext;
                else if (bS.name == 'jyestha' && partnerbS.name == 'ashwini')
                    rem = vdh + vext;
                else if (bS.name == 'punarvasu' && partnerbS.name == 'uttarashada')
                    rem = vdh + vext;
                else if (bS.name == 'uttarashada' && partnerbS.name == 'punarvasu')
                    rem = vdh + vext;
                else if (bS.name == 'uttaraphalguni' && partnerbS.name == 'purvabhadra')
                    rem = vdh + vext;
                else if (bS.name == 'purvabhadra' && partnerbS.name == 'uttaraphalguni')
                    rem = vdh + vext;
                else if (bS.name == 'bharani' && partnerbS.name == 'anuradha')
                    rem = vdh + vext;
                else if (bS.name == 'anuradha' && partnerbS.name == 'bharani')
                    rem = vdh + vext;
                else if (bS.name == 'pushyami' && partnerbS.name == 'purvashada')
                    rem = vdh + vext;
                else if (bS.name == 'purvashada' && partnerbS.name == 'pushyami')
                    rem = vdh + vext;
                else if (bS.name == 'hastha' && partnerbS.name == 'sathabhisha')
                    rem = vdh + vext;
                else if (bS.name == 'sathabhisha' && partnerbS.name == 'hastha')
                    rem = vdh + vext;
                else if (bS.name == 'krittika' && partnerbS.name == 'vishakha')
                    rem = vdh + vext;
                else if (bS.name == 'vishakha' && partnerbS.name == 'krittika')
                    rem = vdh + vext;
                else if (bS.name == 'ashlesha' && partnerbS.name == 'moola')
                    rem = vdh + vext;
                else if (bS.name == 'moola' && partnerbS.name == 'ashlesha')
                    rem = vdh + vext;
                else if (bS.name == 'rohini' && partnerbS.name == 'swati')
                    rem = vdh + vext;
                else if (bS.name == 'swati' && partnerbS.name == 'rohini')
                    rem = vdh + vext;
                else if (bS.name == 'magha' && partnerbS.name == 'revati')
                    rem = vdh + vext;
                else if (bS.name == 'revati' && partnerbS.name == 'magha')
                    rem = vdh + vext;
                else if (bS.name == 'ardra' && partnerbS.name == 'saravana')
                    rem = vdh + vext;
                else if (bS.name == 'saravana' && partnerbS.name == 'ardra')
                    rem = vdh + vext;
                else if (bS.name == 'purvaphalguni' && partnerbS.name == 'uttarabhadra')
                    rem = vdh + vext;
                else if (bS.name == 'uttarabhadra' && partnerbS.name == 'purvaphalguni')
                    rem = vdh + vext;
                else if (bS.name == 'mrigashira' && (partnerbS.name == 'chitra' || partnerbS.name == 'danista'))
                    rem = vdh + vext;
                else if ((bS.name == 'chitra' || bS.name == 'danista') && partnerbS.name == 'chitra')
                    rem = vdh + vext;
                //html += rem + '\n';
    ...
    LovehoroPage.prototype.calcVasya = function (v1, v2) {
        var pts = 0;
        var rem = '';
        if (v1 == 'wild' || v2 == 'wild') {
    ...
    LovehoroPage.prototype.translate = function (lord) {
        if (this.shareService.getLANG() == 'en')
            return lord;
        var trn = lord;
    ...
    ], LovehoroPage.prototype, "gridInfo", void 0);
    LovehoroPage = __decorate([
        NgModule({
        ...
        __metadata("design:paramtypes", [Platform, NavController, NavParams, FormBuilder, HoroscopeService, Renderer2, AppRate, ShareService])
    ], LovehoroPage);
    return LovehoroPage;
}());
export { LovehoroPage };
//# sourceMappingURL=lovehoro.js.map