 ...
 */
var ChartAnalysisPage = /** @class */ (function () {
    function ChartAnalysisPage(navCtrl, navParams, renderer, el, platform, shareService) {
        var _this = this;
    ...
    ChartAnalysisPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ChartAnalysisPage');
    };
    ChartAnalysisPage.prototype.ngAfterViewInit = function () {
        this.asc_sign = '';
        this.trikona_lords = '';
        this.kendra_lords = '';
        this.akashWani = '';
    ...
    ChartAnalysisPage.prototype.analyzHora = function (plPos) {
        ...
        var signs = ['cn', 'le'];
        var cn_p = 0, le_p = 0;
        var ju = 0, ve = 0, me = 0, mo = 0, su = 0, ma = 0, sa = 0;
    ...
    ChartAnalysisPage.prototype.updateNodePos = function () {
    ...
    ChartAnalysisPage.prototype.loadHoro = function (plPos, ele, title, id) {
    ...
    ChartAnalysisPage.prototype.grid = function (numberPerSide, size, pixelsPerSide, plps, title, id) {
    ...
    ;
    ChartAnalysisPage.prototype.calcHoraChart = function () {
        var navPls = [];
        var plPos = this.shareService.getPLPOS();
    ...
    ChartAnalysisPage.prototype.calcDivChart = function (ndivs) {
        var navPls = [];
    ...
    ChartAnalysisPage.prototype.translate = function (lord) {
        if (this.shareService.getLANG() == 'en')
            return lord;
        var trn = lord;
    ...
    ], ChartAnalysisPage.prototype, "divChart", void 0);
    ChartAnalysisPage = __decorate([
        NgModule({
        ...
        __metadata("design:paramtypes", [NavController, NavParams, Renderer2, ElementRef, Platform, ShareService])
    ], ChartAnalysisPage);
    return ChartAnalysisPage;
}());
export { ChartAnalysisPage };
