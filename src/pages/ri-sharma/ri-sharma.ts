...
/**
 * Generated class for the RiSharmaPage page.
 *
...
@Component({
  selector: 'page-ri-sharma',
  templateUrl: 'ri-sharma.html'
})
export class RiSharmaPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad RiSharmaPage');
  }
callreq(event) {
