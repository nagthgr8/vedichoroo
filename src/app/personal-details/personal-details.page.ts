...
//convert Address string to lat and long
 ...
 remDOB(evt, pd) {
	...
	if(efn != '') {
		window.resolveLocalFileSystemURL(this.file.externalDataDirectory, function(dir) {
			dir.getFile(efn, {create:false}, function(fileEntry) {
