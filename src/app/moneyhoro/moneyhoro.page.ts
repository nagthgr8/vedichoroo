...
export class MoneyhoroPage implements OnInit, AfterViewInit {
 ...
 // oDas: Yoga[] = [];
  ...
  akashWani: string = '';
  asc_sign :string = '';
  constructor(private router: Router, private platform: Platform, public shareService: ShareService, private horoService: HoroscopeService, public renderer: Renderer2, public device: Device) { 
