...
export class PanchangPage implements OnInit {
 ...
 // clat: any;
  ...
  arcs: number = 0;
  tithinf: string = '';
  constructor(private router: Router, public platform: Platform, private menu: MenuController, public horoService: HoroscopeService, public shareService: ShareService, public translate: TranslateService, private file: File, public renderer: Renderer2) {//, public admob: AdMob) { 
  ...
  ngOnInit() {
    ...
    this.shareService.getPLAN()
		...
		//   .subscribe(res3 => {
		   ...
		   this.tithinf = this.tithi_info_v[res['tithi']];
