...
//	});	 
  	  this.shareService.getPLAN()
		   .then(res => {
				...
				if(res['name'] != 'com.mypubz.eportal.astrologer' && res['name'] != 'com.mypubz.eportal.adfree' && res['name'] != 'com.mypubz.eportal.year' && res['name'] != 'com.mypubz.eportal.month') {
						this.showSU = true;
						this.showCR = false;
						this.showPAY = true;
