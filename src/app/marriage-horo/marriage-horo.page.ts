...
//convert Address string to lat and long
  ...
  getLoveReport()
  {
	...
	var lbls = ['Excess/Nadi Koota', 'Constructivism/Bha Koota', 'Temperment/Gana Koota', 'Friendship/Grahamitram Koota', 'Instrinctive Compatibility/Yoni Koota', 'Comfort/Tara Koota','Innate Giving/Vasya Koota', 'Mutation/Varna Koota'];
...
//		this.info = JSON.stringify(err);
 ...
 dosdtl(nam) {
  ...
  talk2ast() {
 	    this.router.navigate(['/astrologers'], {queryParams : {title: 'marriage-horo'}});
 }
}
