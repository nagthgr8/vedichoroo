...
export class DivchartsPage implements OnInit {
  ...
  plan: any;
  shwAD: boolean = false;
  constructor(private router: Router, private platform: Platform, private menu: MenuController, public shareService: ShareService, private horoService: HoroscopeService, public renderer: Renderer2, public eleRef: ElementRef) { 
  }
