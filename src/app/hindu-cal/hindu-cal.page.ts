...
export class HinduCalPage implements OnInit {
 ...
 // clat: string;
  ...
  constructor(private router: Router, public platform: Platform, public selector: WheelSelector, public horoService: HoroscopeService, public shareService: ShareService, public translate: TranslateService, private file: File, public eleRef: ElementRef, public renderer: Renderer2) { 
