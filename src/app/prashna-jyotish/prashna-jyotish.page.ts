...
export class PrashnaJyotishPage implements OnInit {
  ...
  ngOnInit() {
    this.info = 'Loading..';
	  ...
	  if(this.clat == -1) {
		  this.info = "The App could not access current location. Prashna Jyotish will not work! please enable location from your App settings, if you want this feature to work. Please contact info@vedichoroo.com for futher help";
	  }
	  ...
	  if(this.clat == -1) {
			  this.info = "The App could not access current location. Prashna Jyotish will not work! please check your App settings. Please contact info@vedichoroo.com for futher help";
	  }
     else  this.rgeoCode2(this.clat, this.clng);
	});
  }
  save()
  {
